...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-113', number: 113, title: "「あの人と比べて」が、学びを止めることがある", url: "https://note.com/manabimapcreator/n/nb0803f69f08a", status: "published", kind: "wonder-note", date: "2026-06-25", target: "第12部第9話「比較されると学習意欲はどう変わるのか」", tags: [], relatedParts: [], relatedPodcastId: "podcast-part12-9", relatedYouTubeId: "youtube-part12", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "「○○ちゃんはできているのに」と言われた瞬間、" },
    ...
    { id: 'note-115', number: 115, title: "見えないものが見えたとき、世界はどう変わるのか", status: "local-draft", kind: "wonder-note", date: "2026-06-20", target: "第14部第2話「道具が認識を変える」", tags: ["第14部第2話「道具が認識を変える」"], relatedParts: [], relatedPodcastId: "podcast-part14-2", relatedYouTubeId: "youtube-part14", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "カバンの中身は、外から見えない。" },
    ...
    { id: 'note-117', number: 117, title: "正しいことが、なぜ受け入れられないことがあるのか", status: "local-draft", kind: "wonder-note", date: "2026-06-20", target: "第14部第4話「新しい知は、なぜ最初に危険だと言われるのか」", tags: ["第14部第4話「新しい知は","なぜ最初に危険だと言われるのか」"], relatedParts: [], relatedPodcastId: "podcast-part14-4", relatedYouTubeId: "youtube-part14", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "「手を洗ってください」" },
    { id: 'note-118', number: 118, title: "「中心ではなかった」は、何度も繰り返されてきた", status: "local-draft", kind: "wonder-note", date: "2026-06-20", target: "第14部第5話「自分の中の天動説を探す」（シリーズ最終回）", tags: [], relatedParts: [], relatedPodcastId: "podcast-part14-5", relatedYouTubeId: "youtube-part14", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "地球は、宇宙の中心ではなかった。" },
    { id: 'note-119', number: 119, title: "なぜ「正しい」と認められるまでに、何十年もかかるのか", url: "https://note.com/manabimapcreator/n/nc0344dc13794", status: "published", kind: "wonder-note", date: "2026-06-26", target: "AI源流第1話", tags: ["AI源流第1話"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-1", relatedYouTubeId: "youtube-AI源流", ctaCopy: "Podcastで深く聴く", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "今、スマホに話しかけると、ちゃんと答えが返ってくる。" },
    { id: 'note-120', number: 120, title: "なぜ「意味」を外すと、測れるものが見えてくるのか", url: "https://note.com/manabimapcreator/n/nd5694b70262c", status: "published", kind: "wonder-note", date: "2026-06-27", target: "AI源流第2話", tags: ["AI源流第2話"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-2", relatedPodcastUrl: "https://www.youtube.com/watch?v=lDV58Z8XxH0", relatedYouTubeId: "youtube-AI源流", relatedYouTubeUrl: "https://www.youtube.com/watch?v=lDV58Z8XxH0", ctaCopy: "Podcastで深く聴く", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "「了解」の二文字だけで、十分に伝わるときがあります。" },
    { id: 'note-121', number: 121, title: "なぜ、答え合わせは「本人が居なくなった後」に来るのか", status: "local-draft", kind: "wonder-note", date: "2026-06-21", target: "AI源流第3話", tags: ["AI源流第3話"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-3", relatedPodcastUrl: "https://www.youtube.com/watch?v=gGcrFlY2Y0E", relatedYouTubeId: "youtube-AI源流", relatedYouTubeUrl: "https://www.youtube.com/watch?v=gGcrFlY2Y0E", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-121.png", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "提出した宿題の答え合わせを、誰よりも先に知りたいと思ったことはありませんか。" },
    { id: 'note-122', number: 122, title: "なぜ「分かっている人には分かっている」だけでは、広がらないのか", status: "local-draft", kind: "wonder-note", date: "2026-06-21", target: "AI源流第4話", tags: ["AI源流第4話"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-4", relatedPodcastUrl: "https://www.youtube.com/watch?v=JR2rViO8-Yw", relatedYouTubeId: "youtube-AI源流", relatedYouTubeUrl: "https://www.youtube.com/watch?v=JR2rViO8-Yw", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-122.png", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "近所では知られているのに、遠くの誰も知らない。" },
    { id: 'note-123', number: 123, title: "なぜ、同じ発見をした二人の名前が、同じだけ知られないのか", status: "local-draft", kind: "wonder-note", date: "2026-06-21", target: "AI源流第5話", tags: ["AI源流第5話"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-5", relatedPodcastUrl: "https://www.youtube.com/watch?v=kgdPnOuaVr0", relatedYouTubeId: "youtube-AI源流", relatedYouTubeUrl: "https://www.youtube.com/watch?v=kgdPnOuaVr0", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-123.png", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "誰かと同じことを、同時に思いついたことはありませんか。" },
    { id: 'note-124', number: 124, title: "なぜ、動く証拠があっても、信じてもらえない時間があるのか", status: "local-draft", kind: "wonder-note", date: "2026-06-21", target: "AI源流第6話", tags: ["AI源流第6話"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-6", relatedPodcastUrl: "https://www.youtube.com/watch?v=268kdjIa7g4", relatedYouTubeId: "youtube-AI源流", relatedYouTubeUrl: "https://www.youtube.com/watch?v=268kdjIa7g4", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-124.png", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "実際に動いているところを見せても、それでも信じてもらえないことがあります。" },
    { id: 'note-125', number: 125, title: "なぜ、作った人ほど、その怖さを早く見抜くのか", status: "local-draft", kind: "wonder-note", date: "2026-06-21", target: "AI源流第7話", tags: ["AI源流第7話"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-7", relatedYouTubeId: "youtube-AI源流", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-125.png", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "自分が作ったものが、思っていたより大きな力を持ってしまったら。" },
    { id: 'note-126', number: 126, title: "なぜ、正しさは静かに積み重なって、ある日突然動くのか", status: "local-draft", kind: "wonder-note", date: "2026-06-21", target: "AI源流第8話（終章）", tags: ["AI源流第8話（終章）"], relatedParts: ["part8"], relatedPodcastId: "podcast-AI源流-8", relatedYouTubeId: "youtube-AI源流", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-126.png", question: "生成AIは、何を生成しているのか。", relation: "生成AIの枝道", primaryPart: "part8", excerpt: "長い旅を振り返ると、いつも同じ形が見えてくることがあります。" }
  ];
