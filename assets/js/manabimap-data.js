...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-69', number: 69, title: "石を割り始める前に、頭の中に完成形があった", status: "local-draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第2話「手と道具」", tags: ["第9部第2話「手と道具」"], relatedParts: ["part9"], ctaCopy: "関連動画を見る", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "ペンを持つとき、包丁を使うとき、スマートフォンを開くとき。" },
