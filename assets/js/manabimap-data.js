...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-92', number: 92, title: "アイスクリームを見たサルが科学を変えた——共感の回路とは何か", url: "https://note.com/manabimapcreator/n/n9273f1227867", status: "published", kind: "wonder-note", date: "2026-07-23", target: "第10部第3話「共感の回路」", tags: ["第10部第3話「共感の回路」"], relatedParts: [], relatedPodcastId: "podcast-part10-3", relatedYouTubeId: "youtube-part10", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-92.png", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "友達が泣いていると、胸が痛くなる。" },
