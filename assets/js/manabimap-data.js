...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-49', number: 49, title: "「時間を売る」という生き方は、いつ始まったのか", url: "https://note.com/manabimapcreator/n/nc6fbb07c59f0", date: "2026-05-05", target: "第1部ポッドキャスト「産業革命の深層」(#1P)", tags: [], relatedParts: ["part1"], question: "機械は人間を何から解放し、何に縛ったのか。", relation: "機械と時間の枝道", primaryPart: "part1", excerpt: "今日も、何時間か働きました。" },
    { id: 'note-50', number: 50, title: "アイデアは、時代が来なければ存在しないのか", url: "https://note.com/manabimapcreator/n/n2ddcdbff48a1", date: "2026-05-07", target: "第2部ポッドキャスト「つながる世界の深層」", tags: [], relatedParts: ["part2"], question: "つながることは、近づくことと同じなのか。", relation: "つながりと思考の枝道", primaryPart: "part2", excerpt: "今日も、スマホを開きました。" },
    { id: 'note-51', number: 51, title: "知識を手放すと、何が生まれるのか", url: "https://note.com/manabimapcreator/n/n36485a76557b", date: "2026-05-07", target: "第2部ポッドキャスト「つながる世界の深層」", tags: [], relatedParts: ["part2"], question: "つながることは、近づくことと同じなのか。", relation: "つながりと思考の枝道", primaryPart: "part2", excerpt: "今日も、ウェブを使いました。" },
    { id: 'note-52', number: 52, title: "核攻撃に耐えるために作られたネットワークが、世界をつないだ", url: "https://note.com/manabimapcreator/n/nfa68c46c8c7b", date: "2026-05-07", target: "第2部ポッドキャスト「つながる世界の深層」", tags: [], relatedParts: ["part2"], question: "つながることは、近づくことと同じなのか。", relation: "つながりと思考の枝道", primaryPart: "part2", excerpt: "今日も、LINEでメッセージを送りました。" },
    { id: 'note-53', number: 53, title: "思い出すことと、覚えていたと気づくことは、同じではない", url: "https://note.com/manabimapcreator/n/n913eb6b8fce3", date: "2026-05-10", target: "第8部第6話「宿題の違和感」（note_45へのコメントから広がった視点）", tags: ["記憶","メタ認知","思い出す","学びとは何か","AI時代の学び","哲学","プラトン","アリストテレス","プルースト","ベルクソン","想起","無意志的記憶","アナムネーシス","知識とは何か","ハルとおじいさん","学びの地図","ManabiMap"], relatedParts: ["part4","part8-2","part8","note"], question: "検索できることと、理解していることは同じなのか。", relation: "知識と記録の枝道", primaryPart: "part4", excerpt: "「それ知ってる。」とつぶやく瞬間がある。" }
  ];
