...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-54', number: 54, title: "自信満々な答えが、一番危ない", url: "https://note.com/manabimapcreator/n/n241de742032b", status: "published", kind: "wonder-note", date: "2026-05-11", target: "第3部ポッドキャスト「AIの深層」", tags: ["ハルシネーション","AI","生成AI","ChatGPT","ダニングクルーガー効果","認知バイアス","確信","批判的思考","AI時代の学び","瀉血","歴史","人類史","ハルとおじいさん","学びの地図","ManabiMap"], relatedParts: ["part18","part3","part5","part8","note","evolution"], relatedPodcastUrl: "https://www.youtube.com/playlist?list=PLJ-qAmzHO2WwJhGwN9UvRFwgltPZ-Y6ur", image: "note_articles/generated_note_images/note-54.png", question: "判断や記憶は、どこで現実を取り違えるのか。", relation: "判断と記憶の枝道", primaryPart: "part18", excerpt: "AIは嘘をつく。" },
    ...
    { id: 'note-56', number: 56, title: "公平に見える技術が、不平等を増幅するとき", url: "https://note.com/manabimapcreator/n/nb4a769d41cde", status: "published", kind: "wonder-note", date: "2026-05-13", target: "第3部ポッドキャスト「AIの深層」", tags: ["AIバイアス","差別","公平性","コダック","シャーリーカード","IQテスト","メルカトル図法","AI倫理","技術と社会","データバイアス","人類史","歴史","ハルとおじいさん","学びの地図","ManabiMap"], relatedParts: ["part18","part3","part8","note","evolution"], relatedPodcastUrl: "https://www.youtube.com/playlist?list=PLJ-qAmzHO2WwJhGwN9UvRFwgltPZ-Y6ur", image: "note_articles/generated_note_images/note-56.png", question: "判断や記憶は、どこで現実を取り違えるのか。", relation: "判断と記憶の枝道", primaryPart: "part18", excerpt: "コンピュータは、感情も偏見も持っていない。" },
