...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-03', number: 3, title: "ChatGPTに同じことを聞くと、なぜ毎回答えが違うのか。", status: "local-draft", tags: ["生成AI","ChatGPT","検索","AI","教育","学び"], relatedParts: ["part3","part4","part8-2","part8"], relatedPodcastUrl: "https://www.youtube.com/playlist?list=PLJ-qAmzHO2WyHi5PE81uv7FzZs2pvfWyC", question: "AIが考えているように見えるとき、人間が考えるとは何か。", relation: "AIと人間の枝道", primaryPart: "part3", excerpt: "ChatGPTに同じ質問を2回したことはありますか？" },
    ...
    { id: 'note-69', number: 69, title: "石を割り始める前に、頭の中に完成形があった", status: "draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第2話「手と道具」", tags: ["第9部第2話「手と道具」"], relatedParts: ["part9"], relatedPodcastUrl: "https://www.youtube.com/watch?v=rd2EIzy0YpE", ctaCopy: "関連動画を見る", image: "note_articles/generated_note_images/note-69.png", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "ペンを持つとき、包丁を使うとき、スマートフォンを開くとき。" },
    { id: 'note-70', number: 70, title: "150人を超えると、何かが壊れる", status: "draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第3話「脳はなぜ大きくなったか」", tags: [], relatedParts: ["part9"], image: "note_articles/generated_note_images/note-70.png", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "フォロワーが増えるほど、なぜか孤独になる。" },
    { id: 'note-71', number: 71, title: "欲望が止まらないのは、設計通りだった", status: "draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第5話「報酬系の設計」", tags: ["第9部第5話「報酬系の設計」"], relatedParts: ["part9"], image: "note_articles/generated_note_images/note-71.png", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "お腹いっぱいなのに、まだ食べたくなる。" },
    ...
    { id: 'note-79', number: 79, title: "痛みがなければよかった、は本当のことだろうか", status: "draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第12話「痛みと意味」", tags: ["第9部第12話「痛みと意味」"], relatedParts: ["part9"], image: "note_articles/generated_note_images/note-79.png", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "転んだとき、歯が痛いとき、誰かに傷つけられたとき。" },
    { id: 'note-80', number: 80, title: "昔聴いた音楽が今も特別なのは、脳が記憶しているからではない", status: "draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第13話「感性とは何か」", tags: ["第9部第13話「感性とは何か」"], relatedParts: ["part9"], image: "note_articles/generated_note_images/note-80.png", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "昔よく聴いていた曲がシャッフルで流れてきた瞬間、" },
    { id: 'note-81', number: 81, title: "「平均的な人間」は、一人も存在しなかった", status: "draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第14話「身体を持つという条件」", tags: [], relatedParts: ["part9"], image: "note_articles/generated_note_images/note-81.png", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "平均身長。平均体重。平均体温。" },
    { id: 'note-82', number: 82, title: "生物進化は止まった。でも人類の変化は止まらない", status: "draft", kind: "wonder-note", date: "2026-05-24", target: "第9部第15話「進化は止まらない」", tags: ["第9部第15話「進化は止まらない」"], relatedParts: ["part9","evolution"], image: "note_articles/generated_note_images/note-82.png", question: "旧石器時代の身体で、生成AI時代をどう生きるのか。", relation: "身体と進化の枝道", primaryPart: "part9", excerpt: "スマートフォンが世界に普及するまで、10年かかりませんでした。" },
    ...
    { id: 'note-108', number: 108, title: "「わかっていない」に気づくのは、説明しようとしたときだ", url: "https://note.com/manabimapcreator/n/nc03210498c14", status: "published", kind: "wonder-note", date: "2026-06-19", target: "第12部第4話「誰かに説明しようとすると理解はなぜ変わるのか」", tags: [], relatedParts: [], relatedPodcastId: "podcast-part12-4", relatedYouTubeId: "youtube-part12", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-108.png", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "発表の準備をしていた。" },
    ...
    { id: 'note-115', number: 115, title: "見えないものが見えたとき、世界はどう変わるのか", status: "draft", kind: "wonder-note", date: "2026-06-20", target: "第14部第2話「道具が認識を変える」", tags: ["第14部第2話「道具が認識を変える」"], relatedParts: [], relatedPodcastId: "podcast-part14-2", relatedYouTubeId: "youtube-part14", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-115.png", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "カバンの中身は、外から見えない。" },
    ...
    { id: 'note-117', number: 117, title: "正しいことが、なぜ受け入れられないことがあるのか", status: "draft", kind: "wonder-note", date: "2026-06-20", target: "第14部第4話「新しい知は、なぜ最初に危険だと言われるのか」", tags: ["第14部第4話「新しい知は","なぜ最初に危険だと言われるのか」"], relatedParts: [], relatedPodcastId: "podcast-part14-4", relatedYouTubeId: "youtube-part14", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-117.png", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "「手を洗ってください」" },
    { id: 'note-118', number: 118, title: "「中心ではなかった」は、何度も繰り返されてきた", status: "draft", kind: "wonder-note", date: "2026-06-20", target: "第14部第5話「自分の中の天動説を探す」（シリーズ最終回）", tags: [], relatedParts: [], relatedPodcastId: "podcast-part14-5", relatedYouTubeId: "youtube-part14", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-118.png", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "地球は、宇宙の中心ではなかった。" },
    ...
    { id: 'note-127', number: 127, title: "「わかった」と思ったとき、考えるのをやめていないか", status: "local-draft", kind: "wonder-note", date: "2026-06-27", target: "第15部第1話「知っているつもりが、一番危ない」", tags: ["第15部第1話「知っているつもりが","一番危ない」"], relatedParts: [], relatedPodcastId: "podcast-part15-1", relatedYouTubeId: "youtube-part15", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "スマホで何かを調べます。" },
    { id: 'note-128', number: 128, title: "「まだわからない」でいることが、なぜこんなに苦しいのか", status: "local-draft", kind: "wonder-note", date: "2026-06-27", target: "第15部第2話「白黒にすると、ちょっと楽になる」", tags: ["第15部第2話「白黒にすると","ちょっと楽になる」"], relatedParts: [], relatedPodcastId: "podcast-part15-2", relatedYouTubeId: "youtube-part15", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "LINEの返信が来ません。" },
    { id: 'note-129', number: 129, title: "「見た」が「わかった」にならないのはなぜか", status: "local-draft", kind: "wonder-note", date: "2026-06-27", target: "第15部第3話「目で見ても、わからないことがある」", tags: ["第15部第3話「目で見ても","わからないことがある」"], relatedParts: [], relatedPodcastId: "podcast-part15-3", relatedYouTubeId: "youtube-part15", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "「これは本当だ」と思います。" },
    { id: 'note-130', number: 130, title: "「まだわからない」を22年間続けると、何が起きるのか", status: "local-draft", kind: "wonder-note", date: "2026-06-27", target: "第15部第4話", tags: ["第15部第4話"], relatedParts: [], relatedPodcastId: "podcast-part15-4", relatedYouTubeId: "youtube-part15", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "「早く決めて」と言われることがあります。" },
    { id: 'note-131', number: 131, title: "普通の人が、なぜ恐ろしいことをするのか", status: "local-draft", kind: "wonder-note", date: "2026-06-27", target: "第15部第5話", tags: ["第15部第5話"], relatedParts: [], relatedPodcastId: "podcast-part15-5", relatedYouTubeId: "youtube-part15", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "「みんながそうしてたから」" },
