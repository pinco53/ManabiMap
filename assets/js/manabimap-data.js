...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-92', number: 92, title: "アイスクリームを見たサルが科学を変えた——共感の回路とは何か", status: "local-draft", kind: "wonder-note", date: "2026-05-31", target: "第10部第3話「共感の回路」", tags: ["第10部第3話「共感の回路」"], relatedParts: [], relatedPodcastId: "podcast-part10-3", relatedPodcastUrl: "https://www.youtube.com/watch?v=GjEa2rHbPSk", relatedYouTubeId: "youtube-part10", relatedYouTubeUrl: "https://www.youtube.com/watch?v=GjEa2rHbPSk", ctaCopy: "Podcastで深く聴く", question: "学ぶとは、答えを増やすことか、問いを増やすことか。", relation: "制作と学びの枝道", primaryPart: "note", excerpt: "友達が泣いていると、胸が痛くなる。" },
