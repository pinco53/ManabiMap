...
(function() {
  ...
  const notes = [
    ...
    { id: 'note-142', number: 142, title: "台所の道具で、太陽が作れると発表された日", url: "https://note.com/manabimapcreator/n/n52f40239ab8b", status: "published", kind: "wonder-note", date: "2026-08-08", target: "第16部第8話", tags: ["第16部第8話"], relatedParts: ["part16"], relatedPodcastId: "podcast-part16-8", relatedYouTubeId: "youtube-part16", ctaCopy: "Podcastで深く聴く", image: "note_articles/generated_note_images/note-142.png", question: "エネルギーを得るたび、人類は何から自由になったのか。次に自由になるのは何か。", relation: "エネルギーと自由の枝道", primaryPart: "part16", excerpt: "ニュースで「画期的な発見」という言葉を見ると、少しだけ、疑ってしまう自分がいます。" },
