(function () {
  ...
  root.innerHTML =
    '<div class="cover"><div class="cover-series">ハルとおじいさんの物語 ── 学びの地図</div><div class="cover-colorname">瑠璃<small>るり</small></div>' +
      ...
      '<div class="cover-divider"></div><div class="cover-note">第16部の本文型補足資料</div><div class="cover-actions"><a class="cover-action" href="../library.html?format=listen">Podcast一覧へ</a><a class="cover-action" href="../library.html?format=read">note記事へ</a></div></div>' +
    ...
    '<div class="page"><div class="section-label">Glossary</div><div class="section-title">用語解説</div><div class="section-intro">第16部の主要概念を、定義だけでなく「なぜ重要か」とともに整理する。</div>' + glossaryHtml +
      ...
      '<div class="bridge-box"><div class="bridge-label">Beyond This Journey</div><div class="bridge-text">エネルギーの解放の歴史は、学びの解放の歴史と同じ構造を持つ。</div><div class="bridge-sub">ハルとおじいさんの物語は、ここで一区切りを迎える。学びの地図トップから、気になる部を読み返してみてほしい。</div></div>' + footer('用語と問い') + '</div>' +
    '<div class="page"><div class="section-label">Resources</div><div class="section-title">さらに読む・聴く</div><div class="section-intro">第16部のPodcast、関連note、本文の背景となる研究資料への入口。</div>' +
      '<div class="resource-grid"><a class="resource-card" href="../library.html?format=listen"><div class="resource-label">PODCAST</div><div class="resource-title">Podcastで聞く</div><div class="resource-text">第16部の8話を音声でたどる。</div></a><a class="resource-card" href="../library.html?format=read"><div class="resource-label">NOTE MAP</div><div class="resource-title">note記事へ</div><div class="resource-text">各テーマから伸びる個別の枝道を読む。</div></a><a class="resource-card" href="../index.html"><div class="resource-label">MANABI MAP</div><div class="resource-title">学びの地図トップへ</div><div class="resource-text">全16部の物語を、もう一度見渡す。</div></a></div>' + notesHtml +
