(function () {
  ...
  const timeline = [
    ['紀元前4世紀', 'アリストテレス『詩学』', '悲劇を模倣として捉え、筋・人物・言葉・感情の働きを分析した。芸術を神秘としてではなく、構造を持つ経験として考える初期の体系的な試みだった。'],
    ['1757年', 'ヒューム「趣味の標準について」', '好みは個人によって違うのに、私たちは優れた判断と未熟な判断を区別する。この矛盾を、経験・比較・偏見からの距離という批評の条件から考えた。'],
    ['1790年', 'カント『判断力批判』', '美の判断は主観的な快に基づきながら、他者にも同意を求めると論じた。「主観なのに普遍性を求める」という感性の難問が明確になった。'],
    ['1871〜72年', 'ダーウィンと性選択・表情の研究', '『人間の由来』と『人及び動物の表情について』で、装飾・選好・表情を進化の歴史の中に置いた。美と感情が生物学の問いにもなった。'],
    ['1992年', 'リゾラッティらのミラーニューロン発見', 'パルマ大学の実験で、サルが行為を実行するときと他者の行為を見るときの両方で反応する神経細胞が報告され、模倣や共感の研究が広がった。'],
    ['1999年', 'ゼキが「神経美学」を提唱', '著書『Inner Vision』で美的経験の神経基盤を探る神経美学を提唱し、脳科学と美学が交差する研究領域が形になった。'],
    ['2011年', '音楽とドーパミンの研究', '音楽で強い感情が生じるとき、期待が高まる段階と快が頂点に達する段階で、異なる脳部位のドーパミン放出が報告された。'],
    ['2018年', 'AI生成作品がオークションへ', 'GANで作られた《エドモン・ド・ベラミー》がクリスティーズで推定額の40倍を超える価格で落札され、作者・データ・選択・制度が問い直された。'],
    ['2020年代', '生成AIと文化の再編', '画像・音楽・文章の大量生成が一般化し、創作の入口は広がった。同時に、作者の権利・文化的多様性・推薦による均質化が中心的な論点になっている。']
  ];
