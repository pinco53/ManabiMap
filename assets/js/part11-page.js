(function () {
  ...
  const timeline = [
    ['1936年', 'ピアジェ『知能の誕生』（仏語原著）', '子どもは大人の知識を縮小コピーするのではなく、行動を通して世界のパターンを自分で組み立てていくと論じた。「教わる前の学び」という第11部全体を貫く視点の出発点である。', ['構成主義', '発達段階']],
    ['1958年', 'ハーロウのアカゲザル実験', '布と針金の代理母を使った実験から、接触の快さが愛着行動の基盤にあることを示した。食べ物だけでは愛着を説明できないことが明らかになり、第9話「抱っこは甘やかしなのか、発達の栄養なのか」につながる知見になった。', ['接触の快', '愛着の基盤']],
    ['1969年', 'ボウルビィ『Attachment and Loss』第1巻', '愛着を、生存に関わる生物学的なシステムとして体系化した。子どもが特定の養育者を求める行動を進化的な視点から説明し、第3話「愛着形成とは何か」の理論的な土台になった。', ['愛着理論']],
    ['1970年', 'エインスワースの愛着の3類型', '「ストレンジ・シチュエーション」の観察から、安定・回避・アンビバレントという愛着の個人差を報告した。第3話が扱う「内的作業モデル」につながる分類である。', ['愛着スタイル', '観察研究']],
    ['1970年', 'ギャロップの鏡像自己認知実験', 'チンパンジーが鏡に映った自分の像を自己として認識できることを報告し、自己認識研究の出発点になった。第6話「赤ちゃんはいつから自分と他人を分けるのか」が引き継ぐ問いである。', ['自己認識', '鏡像']],
    ['1972年', 'ミシェルの「マシュマロ・テスト」', '目の前の報酬を我慢できるかどうかを調べた実験で、待つ力と将来の結果の関連が注目された。第14話「我慢する力はどう育つのか」が扱う、環境や信頼の影響も含めて再検討され続けている実験である。', ['自己制御', '実行機能']],
    ['1975年', 'トロニックの「スティルフェイス」実験', '養育者が無表情で応答を止めると、乳児が強い混乱と回復への働きかけを示すことを観察し、相互調整の重要性を示した。第1話「人はなぜ泣くことから人生を始めるのか」の中心にある知見である。', ['相互調整', '応答']],
    ['1977年', 'メルツォフとムーアの新生児模倣', '生後間もない乳児が大人の表情や手の動きをまねることを報告し、模倣が生得的な土台を持つ可能性を示した。第4話「まねる力が人間を人間にした」の出発点になった研究である。', ['新生児模倣']],
    ['1977年', 'バンデューラの自己効力感理論', '努力や工夫によって課題に働きかけられるという見通しが、行動変容を支える中心的な要因であると提唱した。第15話「できたが自己効力感をつくる」の理論的な柱である。', ['自己効力感']],
    ['1978年', 'ヴィゴツキー『Mind in Society』英訳版', '最近接発達領域(ZPD)の概念が広く知られ、学びを個人の内側だけでなく、他者との協働の中で捉える視点が広がった。第10話「遊びは学びの原型である」が扱う、ガイド付き遊びの理論的背景になっている。', ['最近接発達領域', '足場かけ']],
    ['2000年代', 'ハーバード大学「サーブ・アンド・リターン」', '乳幼児期の応答的なやりとりの重要性を、脳の発達研究に基づいて広く伝える枠組みとして提唱された。第1話「人はなぜ泣くことから人生を始めるのか」が扱う「応答」を、支援や政策の言葉に翻訳した概念である。', ['応答的養育']],
    ['2020年代', '音声AIと子どもの学び', '対話エージェントが子どもの遊びや質問の相手として家庭に入り始め、模倣と応答の対象が人間以外にも広がっている。', [['音声AI', 'green']]]
  ];
